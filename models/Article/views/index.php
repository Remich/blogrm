...
<article id="article-<?php echo $item['id']; ?>" model="Article">
	<header>
		...
		<span class="post-subtitle"><time datetime="<?php echo $item['a_date']; ?>"><?php echo $item['a_date']; ?></time> | <span rel="category" class="editable" model_key="tags"><?php echo $item['tags']; ?></span> | <a href="">0 Comments</a></span>
	</header>
	<section>
