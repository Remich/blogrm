...
<article id="article-<?php echo $item['id']; ?>" model="Article">
	<header>
		...
		<span class="post-subtitle"><time datetime="<?php echo $item['a_date']; ?>"><?php echo $item['a_date']; ?></time> | <span rel="category" class="editable" model_key="tags"><?php echo $item['tags']; ?></span> | <a href=""><?php echo $item['no_of_comments']; ?> Comments</a></span>
	</header>
	<section>
