...
<html lang="en-US">  
	<head>  
		...
		<title>Dead Language Theme | Just another WordPress site</title> 
	...
	<body>
		...
		<header id="logo">  
			<div class="wrapper">
				<hgroup>
					<?php if(isset($this->_ ['tagname'])) {?>
					<h1><?php echo $this->_ ['tagname']; ?></h1>
					<a href="ajax.php?action=load&id=tag_clear"><h2>&laquo; All Tags</h2></a>
					<hr noshade size="1">
					<?php } ?>
					<div id="tagcloud">
		...
		<footer>
			<div class="wrapper">
				<p> 
					2013 Dead Language Theme – <a href="index.php?page_id=17">Contact & Legal Notice</a> – <a href="http://localhost/wordpress/?feed=rss2">RSS</a>
				</p>
				<p>
